...
(function ($) {
	...
	$(document).ready(function () {
		...
		var $portfolioFilters = $(".portfolio ul#portfolio-sorting li").on(
			"click",
			"a",
			function (e) {
				e.preventDefault();
		...
		$("section.portfolio .portfolio-grid").each(function () {
		...
		window.initialize = function () {
			...
			var markers = [["Cloudify", 51.513793, -0.127114]];
